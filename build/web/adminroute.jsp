<%-- 
    Document   : adminroute
    Created on : Mar 26, 2019, 6:27:26 PM
    Author     : Dell
--%>
...
<!--  <a href="#about">Profile</a>-->
  <a href="#contact"><i class="fa fa-bus"></i> Bus Route</a>
                ...
                <form action="delete.jsp" method="post">
                    <table align="center" class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <td><%=droppoint%></td>
                                <td><%=droptime%></td>
                                <td> <a href="edit.jsp?id=<%=id%>&busno=<%=busno%>&pickuppoint=<%=pickuppoint%>&arrivaltime=<%=arrivaltime%>&droppoint=<%=droppoint%>&droptime=<%=droptime%>"  class="btn btn-warning btn-md">Update</a> 
                        ...
                        <a href="addschedule.jsp"  class="btn btn-block btn-primary" value="Add Schedule">Add Schedule</a>
                </form> 
            </div>
</div>
